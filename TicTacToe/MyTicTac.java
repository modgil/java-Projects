...
JOptionPane.showMessageDialog( MyTicTac.this,
 "Click the button to\n put X On it  \n try to make \nThree consecutive X \n\t eg.....\"XXX\"",
...
if(button[index].getText()==""){
	...
	nextMove();
		...
		JOptionPane.showMessageDialog(MyTicTac.this,"Sorry try an empty square","SORRY!!!!!",JOptionPane.ERROR_MESSAGE);
		...
		win=6;
			...
			win=1;
			 ...
			 win=5;
				...
				else if((Status[1]=="")&&(Status[2]=="")&&(Status[3]=="")&&(Status[4]=="")&&(Status[5]=="")&&(Status[6]=="")&&(Status[7]=="")&&(Status[8]=="")&&(Status[9]==""))
				win=7;
...
//***********************************************display  of the result*******************************************************
	public  void gameStop( String winner ) {
        if ( winner == "tie" ){
            JOptionPane.showMessageDialog( MyTicTac.this, "Would you like to play again???\n think better this time",
		...
		int choice;
		  if(winner=="X"){
			...
			choice = JOptionPane.showConfirmDialog( MyTicTac.this, output,
